********************************************************************************
*         PLOTSUMS - plots within-group arithmetic means across groups    
********************************************************************************
...
capture program drop PLOTSUMS

program define PLOTSUMS
	syntax varlist(max=1) [if], over(varname) [clear divx(int 1) FRame(string) GRaph(name) NOGen NOLabel OPTions(string) PATtern IFLabel PLOTonly  ] 
